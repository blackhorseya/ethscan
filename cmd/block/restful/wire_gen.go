...
var providerSet = wire.NewSet(config.ProviderSet, log.ProviderSet, mariadb.ProviderSet, httpx.ProviderServerSet, kafka.ProviderProducer, grpcx.ProviderClient, restful.BlockSet, biz.BlockSet, NewService)
